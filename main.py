...
from moe import MixtureOfExpertsNEURWIN, NEURWIN, fcnn
...
agent = MixtureOfExpertsNEURWIN(stateSize=STATESIZE,lr=learningRate, env=deadlineEnv, sigmoidParam=sigmoidParam, numEpisodes=numEpisodes, noiseVar=noiseVar,
seed=SEED, batchSize=BATCHSIZE, discountFactor=discountFactor, saveDir = deadlineDirectory, episodeSaveInterval=5, num_experts=10)
agent.learn()
